...
$email = 'robiya365@icloud.com';
$phoneNumber = '762364554';
$skills = [
    [
        'name' => 'Фотошоп',
        'percent' => 30,
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-third">
        <div class="w3-white w3-text-grey w3-card-4">
          ...
          <div class="w3-container">
            ...
            <p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $city ?>а</p>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php for($i = 0; $i < count($experienceWork); $i++): ?>
          <div class="w3-container">
            <h5 class="w3-opacity"><b> <?=$experienceWork[$i]['job']?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$experienceWork[$i]['startDate']?> - <span
                class="w3-tag w3-teal w3-round"><?=$experienceWork[$i]['endDate']?></span></h6>
            <p><?=$experienceWork[$i]['description']?></p>
            <hr>
            <?php endfor;?>
        <!--  </div>-->
        <!--  <div class="w3-container">-->
